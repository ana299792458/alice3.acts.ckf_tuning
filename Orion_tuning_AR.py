...
n_events = 10
n_trials = 100
run_name = "n"+str(n_events)+"t"+str(n_trials) + "AR" + "e34" 
...
class Objective:
    ...
    def __call__(
        ...
        outputDir = Path(srcDir / "Orion_output_CKF/tmp_AR")
        outputfile = srcDir / "Orion_output_CKF/tmp_AR/performance_ckf.root"
        outputDir.mkdir(exist_ok=True)
        ...
        timingfile = srcDir / "Orion_output_CKF/tmp_AR/timing.tsv"
