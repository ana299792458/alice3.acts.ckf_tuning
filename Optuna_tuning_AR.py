...
n_events = 10
n_trials = 100
run_name = "n"+str(n_events)+"t"+str(n_trials) + "AR" + "e12" 
...
class Objective:
    ...
    def __call__(self, trial):
        ...
        outputDir = Path(srcDir / "Optuna_output_CKF/tmp_AR")
        outputfile = srcDir / "Optuna_output_CKF/tmp_AR/performance_ckf.root"
        outputDir.mkdir(exist_ok=True)
        ...
        timingfile = srcDir / "Optuna_output_CKF/tmp_AR/timing.tsv"
...
def main():
    ...
    for i in range(nEta):
        ...
        EtaRange_data = {"eta": [EtaMin, EtaMax]} 
